...
public class Tutorial : MonoBehaviour
{
    ...
    private bool OnlySekaliAnalog = false;

    private void Start()
    {
        QuestTutorial = Quest.GetComponent<QuestTutorial>();
        NextStep();
    }
    ...
    {
        QuestTutorial.SetText(kalimat[k]);
    }
    public void OnlyOnceAnalog()
    {
        if (!OnlySekaliAnalog)
        {
            NextStep();
            OnlySekaliAnalog = true;
        }
    }
